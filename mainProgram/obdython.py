		...
		if self.device.State != 0:
			...
			while 1:
				...
				if buffer != "" or c != ">":  # if something is in buffer, add everything
					buffer = buffer + c
				#print("obdython: " + buffer)
			return buffer
		else:
			print("obdython: " + "NO self.port!")
		return Device.ERROR
...
class Device:
	...
	def __init__(self, type, serial_device="", baud=38400, databits=8, par=serial.PARITY_NONE, stopbits=1, timeout=2, bluetooth_mac="", bluetooth_channel=""):
...
SENSORS = {  # TODO: Complete definitions for all PIDs
	...
	'gear': Sensor("gear", "gear", "22199a", lambda a: a, ""),
	...
	'temp': Sensor("temp", "TEMP", "0105", lambda a: a - 40, "C"),
	...
	'voltage': Sensor("voltage", "Voltage", "0142", lambda a, b: ((a*256)+b)/1000, "x"),
	...
	'rpm': Sensor("rpm", "RPM", "010C1", lambda a, b: (a * 256 + b) / 4, ""),
	'speed': Sensor("speed", "SPD", "010D1", lambda a: a, "KPH"),
